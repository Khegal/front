...
function ColorProvider({ children }: ColorProviderProps) {
  ...
  const transBg = useColorModeValue("rgba(0,0,0,.1)", "rgba(253,253,253,.6)")
  const gradientBG = useColorModeValue("linear-gradient(to top, rgba(237,242,247,1), rgba(237,242,247,0.3))", "linear-gradient(to top, rgba(26,32,44,1), rgba(26,32,44,0.3))")
const value = {
    bg,
    softBg,
    secondaryBgHex,
